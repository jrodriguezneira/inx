...
function get_trend($parameter, $sku=null,$date=null,$rrp=null){
   ...
   //Queries depending on information required 
    ...
    $sql_closest_price="select price from products_last where segment='LOYALTY_CON' and price NOT IN (\"['1000.0 - 0.0']\",\"['10000.0 - 0.0']\") order by abs(rrp - $rrp),price desc limit 1;";
