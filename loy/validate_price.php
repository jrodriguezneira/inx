            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"><b>Validate Price</b> </h1>
                        ...
                        <div class="col-xl-9 col-lg-9">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Pricing Tiers</h6>
                                    <div class="dropdown no-arrow">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                            ...
                                            <a id="excel" class="dropdown-item" href="validate_price.php?rep=excel">Export Pricing(xls)</a>                                              </div>
                                    </div>
                                </div>
